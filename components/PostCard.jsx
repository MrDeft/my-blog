...
export default function PostCard({ post }) {
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      <h1 className="transition duration-700 text-center mb-8 cursor-pointer text-gray-700 hover:text-indigo-700 text-3xl font-semibold">
      ...
      <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
        ...
        <div className="font-medium text-gray-700 align-middle">
          <svg
